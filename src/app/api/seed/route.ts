...
// POST /api/seed - Seed database (only for development)
    ...
    try {
        ...
        const novels = [
            ...
            },
            {
                title: "Solo Leveling",
                slug: "solo-leveling",
                synopsis: "Sung Jin-Woo adalah hunter terlemah di Korea. Suatu hari, ia hampir mati di sebuah dungeon berbahaya dan mendapatkan kekuatan misterius yang memungkinkannya naik level seperti dalam game.",
            ...
            },
            {
                ...
                synopsis: "Zhou Mingrui terbangun di dunia era Victoria yang dipenuhi misteri dan kekuatan supranatural. Ia menemukan dirinya dalam tubuh seorang pemuda bernama Klein Moretti.",
            ...
            },
            {
                title: "Shadow Slave",
                slug: "shadow-slave",
                synopsis: "Sunny adalah seorang budak yang terjebak di Realm Mimpi, dunia penuh nightmare dan monster. Untuk bertahan hidup dan mendapatkan kebebasan, ia harus menaklukkan Shadow Core.",
            ...
            },
            {
                title: "Martial Peak",
                slug: "martial-peak",
                synopsis: "Yang Kai adalah murid biasa di High Heaven Pavilion sampai ia menemukan buku hitam misterius.",
            ...
            },
            {
                ...
                synopsis: "Meng Hao adalah seorang sarjana miskin yang dipaksa bergabung dengan sekte kultivasi.",
            ...
            },
            {
                ...
                synopsis: "Yang Chen, mantan pemimpin organisasi pembunuh legendaris, kembali ke kehidupan normal dan menikah dengan CEO cantik Lin Ruoxi.",
            ...
            },
            {
                ...
                synopsis: "Li Qiye adalah Crow Hitam yang telah hidup selama jutaan tahun, membimbing Immortal Emperors menuju puncak.",
            ...
            },
            {
                ...
                synopsis: "Chen Fan, seorang Immortal Cultivator yang gagal, terlahir kembali ke masa SMA-nya.",
        ...
        if (tbate) {
            const chapters = [
                ...
                },
                {
                    ...
                    contentTranslated: `"Reynolds, lihat ini!" Alice berbisik dengan mata terbelalak.\n\nDi halaman belakang, Arthur kecil sedang bermain dengan bola api kecil yang melayang di telapak tangannya.`,
                    wordCount: 135,
                },
            ]
        ...
        return NextResponse.json({
            ...
            counts: { novels: novelCount, genres: genreCount, chapters: chapterCount },
        })
    } catch (error) {
