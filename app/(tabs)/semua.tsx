...
const styles = StyleSheet.create({
  ...
  filterActive: { backgroundColor: 'rgba(245,158,11,0.14)', borderColor: '#F59E0B' },
  filterActiveBlue: { backgroundColor: 'rgba(16,185,129,0.14)', borderColor: '#10B981' },
  filterText: { fontSize: 12, fontWeight: '600', color: TEXT_DIM },
  filterTextActive: { color: '#FBBF24' },
  filterTextActiveBlue: { color: '#34D399' },
